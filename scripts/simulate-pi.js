...
/**
 * RecyclePay - Raspberry Pi Simulator
 *
 * This script simulates the Raspberry Pi behavior for testing.
 * It polls Supabase for active sessions and simulates bottle verification.
 *
 * Usage: node scripts/simulate-pi.js [bin_id] [success_rate]
 * Example: node scripts/simulate-pi.js 001        (always accept)
 * Example: node scripts/simulate-pi.js 001 0.7    (70% success rate)
 * Example: node scripts/simulate-pi.js 001 0      (always reject)
 */
...
console.log('🤖 RecyclePay Raspberry Pi Simulator');
console.log('=====================================');
